...
public class BillServiceImpl implements BillService {
    ...
    private static final String PDF_LOCATION = "./com.demo/bills/";
...
//            int netTotal = bill.getTotalAmount() + tax;
            ...
            document.add(new Paragraph(" "));
            Paragraph thankYou = new Paragraph("Thank you for your order!", FontFactory.getFont(FontFactory.HELVETICA_BOLDOBLIQUE, 15));
