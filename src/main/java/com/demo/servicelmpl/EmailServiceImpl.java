...
public void sendBillEmail(Delivery delivery) {
    try {
        ...
        helper.setFrom(new InternetAddress("cantino287@gmail.com", "Cantino")); // <== Set name here
        ...
        body.append("Dear ").append(delivery.getName()).append(",\n\n")
                .append("Thank you for your order. Below is your Invoice.\n\n")
...
//                        .orElse("No products"))
//                .append("\n\n")
                .append("We appreciate your Ordering!\n\n")
                .append("Best regards,\nCantino Team");
