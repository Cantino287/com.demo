...
//@GetMapping("/all")
//public List<TableLogin> getAllTables(@RequestHeader("role") String role) {
//    if ("admin".equalsIgnoreCase(role)) {
//        return tableLoginService.getAllTables();
//    } else {
//        throw new ResponseStatusException(HttpStatus.FORBIDDEN, "Only admins can access all tables");
//    }
//}
